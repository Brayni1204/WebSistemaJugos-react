...
const commentController = __importStar(require("@/features/controllers/commentController"));
...
router.post('/:pageType/:pageId', customerAuthMiddleware_1.default, commentController.createComment);
