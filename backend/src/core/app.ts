...
import novedadesRoutes from '@/api/admin/novedadesRoutes';
import commentManagementRoutes from '@/api/admin/commentManagementRoutes';
...
import publicNovedadesRoutes from '@/api/public/novedadesRoutes';
...
app.use('/api/admin', commentManagementRoutes);
app.use('/api/admin', dashboardRoutes);
app.use('/api/admin', novedadesRoutes);
...
app.use('/api/public', publicNovedadesRoutes);
